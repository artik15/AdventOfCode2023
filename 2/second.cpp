...
int main(int argc, char** argv)
{
    ...
    std::string str;
    int power_sum, max_red, max_green, max_blue;
    game_t game;
    ...
    while (std::getline(file, str))
    {
        ...
        power_sum += game.red_balls * game.green_balls * game.blue_balls;
        // printf("Game %d Red %d Green %d Blue %d Power %d\n", game.id, game.red_balls, game.green_balls, game.blue_balls, power_sum);
    }
